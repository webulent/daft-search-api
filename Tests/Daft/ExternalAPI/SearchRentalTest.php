 ...
 */
class SearchRentalTest extends PHPUnit_Framework_TestCase
{
    private $_object;

    public function setUp()
    {
        $text = '3 or 4 bed house to let in Dundrum for 1000 per month';

        $this->_object = $this->getMockBuilder('\Daft\ExternalAPI\SearchRental')
